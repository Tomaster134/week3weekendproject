class Calculator:
    #overall class so multiple properties can be added and held in memory until user is done
    ...
    def add_property(self):
        ...
        question = input('Please give a name to this property or type RETURN to return to initial menu. ').lower()
        if question == 'return': return 'return'
    ...
    def show_props(self):
        ...
        if self.properties:
            ...
            for each in self.properties:
                ...
                print('-----------------------------------')
        else: print('You haven\'t added any properties yet, silly goose!')
...
class Rental:
    ...
    def calculate(self):
        ...
        try:
            self.roi = (self.cash_flow / sum(self.down_payment.values()))*100
        except ZeroDivisionError: print('Huh. You recieved the property for free? Well then buddy, I can\'t give you a return on investment, since I can\'t divide by zero.')
